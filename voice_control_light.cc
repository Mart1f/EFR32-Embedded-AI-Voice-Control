...
#ifndef DEBUG_PRINT_EVERY_N
#define DEBUG_PRINT_EVERY_N 8   // imprime cada 5 inferencias para no spamear
#endif
...
static sl_status_t process_output()
{
  ...
  // Timestamp para el recognizer
  current_time_stamp = sl_sleeptimer_tick_to_ms(
